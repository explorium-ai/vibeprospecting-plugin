...
Full parameter documentation is in [`skills/vibe-prospecting/SKILL.md`](https://github.com/explorium-ai/vibeprospecting-plugin/blob/main/skills/vibe-prospecting/SKILL.md).
...
| Full skill and tool parameter reference | [SKILL.md](https://github.com/explorium-ai/vibeprospecting-plugin/blob/main/skills/vibe-prospecting/SKILL.md) |
...
| Skill and tool reference | [skills/vibe-prospecting/SKILL.md](https://github.com/explorium-ai/vibeprospecting-plugin/blob/main/skills/vibe-prospecting/SKILL.md) |
